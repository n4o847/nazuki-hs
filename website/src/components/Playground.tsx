...
export function Playground() {
  ...
  const assemble = async () => {
    setAssembling(true);
    await nazuki
      .assemble({ source: assemblySource })
      .then((result) => {
        if (result.status === "success") {
          setResult(result.output);
          setAlerts([]);
            ...
            <Col>
              ...
              <Form.Group>
                <ToggleButtonGroup
                  ...
                  defaultValue={mode}
                >
                  <ToggleButton value="script" variant="secondary">
                    Script
                  </ToggleButton>
                  <ToggleButton value="assembly" variant="secondary">
                    Assembly
                  </ToggleButton>
                </ToggleButtonGroup>
                {mode === "script" ? (
                  ...
                  <Button variant="primary" onClick={assemble}>
