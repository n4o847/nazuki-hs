...
createBanner code =
  Text.concat
    [ quoteSingleLine ("This Brainfuck code is generated by Nazuki v" <> Text.pack (showVersion version) <> "."),
      "\n",
      quoteSingleLine "For more information, see http://github.com/n4o847/nazuki-hs.",
      "\n",
      quoteSingleLine "The original code is as follows:",
      "\n",
